...
// NASM reserved words that cannot be used as labels
static bool isNasmReservedWord(const std::string& name) {
...
static std::string safeNasmName(const std::string& name) {
